...
" Modified: Jmaurice: only added SGI STL keyword, no need to override the
" default syntax file that comes with vim. 
" To use put this in $HOME/vimfiles/after/syntax/cpp.vim
