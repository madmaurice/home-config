...
"------------------------------------------------------------------------------------------
let s:C_AuthorName      = "Jonathan Maurice"                             " |AUTHOR|
...
let s:Py_Template_Header      = "python-file-header"
"
...
function! C_CommentTemplates (arg)
	...
	if s:C_Comments == 'yes' 
		...
		if a:arg=='python-header'
			let templatefile=s:C_Template_Directory.s:Py_Template_Header
		endif
	...
	if filereadable(templatefile)
		...
		call  C_SubstituteTag( pos1, pos2, '|HPP_|',            toupper("_PARAXIP_".expand("%:r")."_HPP_") )
		call  C_SubstituteTag( pos1, pos2, '|INC_HPP_|',        (" \"".expand("%:r").".hpp\"") )
		call  C_SubstituteTag( pos1, pos2, '|_LOGGER_|',        ("PARAXIP_LOGGER_DEFINE(\"paraxip.voip.".expand("%:r")."\");") )
		call  C_SubstituteTag( pos1, pos2, '|_COMPILING_|',   ("(defined(__COMPILING_".expand("%:r")."_CPP__) && defined(WIN32))") )
